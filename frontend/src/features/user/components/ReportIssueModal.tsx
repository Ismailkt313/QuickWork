  ...
  return createPortal(
    <div className="qw-modal-overlay" onClick={onClose}>
      ...
      <style>{`
        ...
        .qw-modal-form::-webkit-scrollbar { width: 6px; }
        .qw-modal-form::-webkit-scrollbar-track { background: transparent; }
        .qw-modal-form::-webkit-scrollbar-thumb { background-color: #cbd5e1; border-radius: 20px; }
        .qw-modal-form::-webkit-scrollbar-thumb:hover { background-color: #94a3b8; }
