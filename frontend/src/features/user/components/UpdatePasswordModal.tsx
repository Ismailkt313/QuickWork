...
const UpdatePasswordModal: React.FC<UpdatePasswordModalProps> = ({ 
  ...
  const onSubmit = async (data: PasswordFormData) => {
    try {
      ...
      const errorMessage = error.message || (typeof error === 'string' ? error : 'Failed to change password');
            ...
            <div className="modal-body p-4 pt-4">
              <div className="mb-3 text-start">
                ...
                <div className="input-group">
                  ...
                  />
                  {errors.currentPassword && <div className="invalid-feedback d-block text-danger small mt-1">{errors.currentPassword.message}</div>}
                </div>
              </div>
              ...
              <div className="mb-3 text-start">
                ...
                <div className="input-group">
                  ...
                  />
                  {errors.newPassword && <div className="invalid-feedback d-block text-danger small mt-1">{errors.newPassword.message}</div>}
                </div>
              </div>
              ...
              <div className="mb-1 text-start">
                ...
                <div className="input-group">
                  ...
                  />
                  {errors.confirmPassword && <div className="invalid-feedback d-block text-danger small mt-1">{errors.confirmPassword.message}</div>}
                </div>
              </div>
            </div>
