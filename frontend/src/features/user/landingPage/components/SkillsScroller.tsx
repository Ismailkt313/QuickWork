...
const SkillsScroller: React.FC<SkillsScrollerProps> = ({ skills, loading, onSkillClick }) => {
    ...
    <div className="position-relative">
      ...
      >
        ...
        {items.map((skill, i) =>
          loading
            ? <SkeletonCard key={i} />
            : <SkillCard key={(skill as Skill)._id} skill={skill as Skill} onClick={onSkillClick} />
        )}
      </div>
