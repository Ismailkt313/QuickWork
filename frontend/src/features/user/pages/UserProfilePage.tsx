...
import { RiUser3Line, RiMailLine, RiPhoneLine, RiShieldLine, RiEditLine, RiTimeLine } from 'react-icons/ri';
    ...
    return (
        <div className="container-fluid py-4 animate-fade-in" style={{ maxWidth: '1000px' }}>
            ...
            <div className="mb-4">
                ...
                <p className="text-secondary small">Manage your personal information and security settings</p>
            </div>
                        ...
                        <div className="card-body p-4">
                            <div className="row g-4">
                                <div className="col-12 col-md-6 text-start">
                                    <label className="text-secondary small fw-bold text-uppercase mb-1 d-block">Full Name</label>
                                    <div className="fw-semibold text-dark p-2 rounded bg-light border-start border-primary border-4">
                                        {user.name}
                                    </div>
                                </div>
                                <div className="col-12 col-md-6 text-start">
                                    <label className="text-secondary small fw-bold text-uppercase mb-1 d-block">Email Address</label>
                                ...
                                <div className="col-12 col-md-6 text-start">
                                    <label className="text-secondary small fw-bold text-uppercase mb-1 d-block">Phone Number</label>
                                ...
                                <div className="col-12 col-md-6 text-start">
                                    <label className="text-secondary small fw-bold text-uppercase mb-1 d-block">Account Type</label>
                        ...
                        <div className="card-body p-4">
                            <div className="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3 text-start">
                                <div>
                                    ...
                                    <p className="text-secondary small mb-0">It's a good idea to use a strong password that you're not using elsewhere</p>
                                </div>
                                <button 
