...
const LoginRestrictionModal: React.FC<LoginRestrictionModalProps> = ({
  ...
  const config = {
    restricted: {
      ...
      message: "Please log in to explore all the features of QuickWork. Join our community to connect with top service providers.",
    ...
    expired: {
      ...
      message: "For your security, your session has ended. Please log in again to continue managing your projects.",
  ...
  return (
    <div 
      style={{
        ...
        padding: '24px', animation: 'lrmFadeIn 0.3s ease'
      }}
    ...
    >
      ...
      >
        <div style={{
          ...
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          fontSize: 32, color: '#fff', margin: '0 auto 32px',
        ...
        <h2 style={{ 
          ...
          color: '#0f172a', margin: '0 0 16px', letterSpacing: '-0.5px' 
        }}>
          {config.title}
        </h2>
