    ...
    return (
        <div className="auth-card">
            <div className="text-center mb-4">
                <div className="d-inline-flex align-items-center justify-content-center rounded-circle mb-4" style={{ width: '80px', height: '80px', backgroundColor: '#f0fdf4' }}>
                    <i className="bi bi-shield-lock" style={{ fontSize: '2rem', color: '#10b981' }}></i>
                </div>
                <h1 className="auth-card-title">Reset password</h1>
                <p className="auth-card-subtitle">
                    Enter the code sent to <span className="fw-semibold text-dark">{email}</span> and your new password.
                </p>
            </div>
            ...
            {success ? (
                <div className="text-center py-2">
                    <div className="auth-ssl-badge mb-4" style={{ background: 'rgba(16, 185, 129, 0.1)' }}>
                        ...
                        <span className="ms-2 fw-semibold text-success">Password reset successfully!</span>
                    </div>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        <label className="auth-label text-center d-block">Verification Code</label>
                        ...
                        {newPassword.length > 0 && (
                            <div className="mt-2">
                                ...
                                <div className="d-flex justify-content-between mt-1">
                                    <small className="text-secondary" style={{ fontSize: '0.6875rem' }}>Strength: <span className={strengthTextClass(strength)}>{strengthLabel(strength)}</span></small>
                                </div>
                            </div>
                        )}
                    </div>
