...
const UserManagement = () => {
    ...
    const openBlockConfirm = (userId: string, userName: string, isBlocked: boolean) => {
        setConfirmState({ show: true, userId, userName, isBlocked, loading: false });
    };

    const closeConfirm = () => {
        if (confirmState.loading) return;
        setConfirmState({ show: false, userId: "", userName: "", isBlocked: false, loading: false });
    };
            ...
            {confirmState.show && (
                <div className="confirm-modal-overlay" onClick={closeConfirm}>
                    <div className="confirm-modal-card" onClick={(e) => e.stopPropagation()}>
                        <div className={`confirm-modal-icon ${confirmState.isBlocked ? "unblock" : "block"}`}>
                            <i className={`bi ${confirmState.isBlocked ? "bi-unlock-fill" : "bi-lock-fill"}`}></i>
                        </div>
                        <div className="confirm-modal-title">
                            {confirmState.isBlocked ? "Unblock" : "Block"} User
                        </div>
                        <div className="confirm-modal-message">
                            Are you sure you want to {confirmState.isBlocked ? "unblock" : "block"}{" "}
                        ...
                        <div className="confirm-modal-actions">
                            ...
                            >
                                {confirmState.loading
                                    ? "Processing..."
                                    : confirmState.isBlocked ? "Yes, Unblock" : "Yes, Block"}
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div className="admin-page-header">
                <div>
                    ...
                    <p className="admin-page-subtitle">
                        Review user activity, manage account status, and monitor platform safety scores.
                    </p>
                </div>
                    ...
                    <>
                        ...
                        <div className="admin-table-footer">
                            {/* <span className="table-showing-text">
                                Showing <strong>{startItem} to {endItem}</strong> of { total.toLocaleString()} users
                            </span> */}
                            {renderPagination()}
                        </div>
                    </>
