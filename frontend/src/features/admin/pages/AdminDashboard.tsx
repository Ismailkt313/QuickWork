    ...
    return (
        <div>
            ...
            <div className="admin-stats-row" style={{ marginBottom: "1.5rem" }}>
                <div className="admin-stat-card">
                    ...
                    <div className="admin-stat-value blue">
                        <i className="bi bi-people" style={{ fontSize: "1.25rem", marginRight: 8 }}></i>
                        0
                    </div>
                </div>
                <div className="admin-stat-card">
                    ...
                    <div className="admin-stat-value" style={{ color: "#16a34a" }}>
                        <i className="bi bi-briefcase" style={{ fontSize: "1.25rem", marginRight: 8 }}></i>
                        0
                    </div>
                </div>
                <div className="admin-stat-card">
                    ...
                    <div className="admin-stat-value orange">
                        <i className="bi bi-currency-dollar" style={{ fontSize: "1.25rem", marginRight: 8 }}></i>
                        $0
                    </div>
                </div>
            </div>
            ...
            <div className="admin-table-card" style={{ padding: "3rem 2rem", textAlign: "center" }}>
                <i className="bi bi-speedometer2 d-block mb-3" style={{ fontSize: "2.5rem", color: "#cbd5e1" }}></i>
                <p style={{ color: "#64748b", fontSize: "0.9375rem" }}>
                    Dashboard analytics coming soon. Use the sidebar to manage users and platform settings.
                </p>
            </div>
        </div>
    );
