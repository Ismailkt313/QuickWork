    ...
    return (
        ...
        >
            <div 
                ...
                style={{ 
                    maxWidth: '700px', width: '95%', padding: '0', 
            ...
            >
                ...
                <div style={{
                    ...
                    padding: '40px 32px', color: '#fff', position: 'relative'
                }}>
                    <button 
                        onClick={onClose}
                        style={{
                    ...
                    <div style={{ display: 'flex', gap: '24px', alignItems: 'center' }}>
                        <div style={{
                            ...
                            background: '#fff', overflow: 'hidden', border: '4px solid rgba(255,255,255,0.1)',
                            flexShrink: 0
                        }}>
                            {provider.profileImage ? (
                                ...
                                <div style={{ 
                                    ...
                                    alignItems: 'center', justifyContent: 'center',
                                    fontSize: 32, color: '#0f172a', fontWeight: 700,
                                    background: '#f1f5f9'
                                }}>
                        ...
                        <div>
                            <h2 style={{ fontSize: 24, fontWeight: 800, margin: '0 0 4px' }}>{provider.userId.name}</h2>
                            <p style={{ fontSize: 16, color: '#94a3b8', margin: '0 0 12px', fontWeight: 500 }}>{provider.headline}</p>
                            <span style={{
                                padding: '4px 12px', borderRadius: '20px', fontSize: 12,
                                fontWeight: 600, textTransform: 'uppercase',
                                background: provider.verification.status === 'VERIFIED' ? '#059669' : '#d97706'
                            }}>
                ...
                <div style={{ padding: '32px', overflowY: 'auto', flexGrow: 1 }}>
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginBottom: '32px' }}>
                        <InfoItem icon="bi-envelope" label="Email Address" value={provider.userId.email} />
                        <InfoItem icon="bi-telephone" label="Phone Number" value={provider.userId.phone || 'Not provided'} />
                        <InfoItem icon="bi-geo-alt" label="Location" value={provider.location.name} />
                        <InfoItem icon="bi-briefcase" label="Experience" value={`${provider.yearsOfExperience} Years`} />
                    </div>
...
const SectionTitle = ({ title }: { title: string }) => (
    <h3 style={{ fontSize: 14, fontWeight: 800, color: '#0f172a', marginBottom: '12px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
        {title}
    </h3>
);
