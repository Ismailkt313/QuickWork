...
const ProviderProfilePage: React.FC = () => {
  ...
  const creationDate = new Date(profile.submittedAt).toLocaleDateString('en-US', {
    month: 'long',
    year: 'numeric'
  });
              ...
              <div className="d-flex flex-wrap gap-4 align-items-end">
                <div className="qw-profile-avatar-wrap">
                  {profile.profileImage ? (
                    <img src={profile.profileImage} alt={profile.name} className="qw-profile-avatar" />
                  ) : (
                  ...
                  {profile.verificationStatus === 'verified' && (
                    <span className="qw-verified-badge" title="Verified Provider">
                      <RiVerifiedBadgeFill />
                    </span>
                  )}
                </div>
                <div className="qw-profile-basic-info flex-grow-1">
                  <div className="d-flex justify-content-between align-items-start">
                    <div>
                      ...
                      <p className="qw-headline text-muted mb-2">{profile.headline || 'No headline set'}</p>
                      <div className="d-flex flex-wrap gap-3 qw-meta">
                        <span className="d-flex align-items-center gap-1">
                          <RiMapPinLine className="qw-icon-sm" /> {profile.location.name}
                        </span>
                        <span className="d-flex align-items-center gap-1">
                          <RiTimeLine className="qw-icon-sm" /> Joined {creationDate}
                        </span>
                        <span className={`badge ${profile.isActive ? 'bg-success-subtle text-success' : 'bg-secondary-subtle text-muted'}`}>
                ...
                <div key={idx} className="col-md-6">
                  <div className="qw-portfolio-item h-100">
                    <div className="qw-portfolio-image-wrap">
                      <img src={item.images[0]} alt={item.title} className="qw-portfolio-image" />
        ...
        <div className="col-lg-4">
          ...
          <div className="qw-card p-4 mb-4">
            ...
            <div className="qw-stat-item d-flex align-items-center gap-3 mb-4">
              <div className="qw-stat-icon red"><RiMoneyDollarCircleLine /></div>
              <div>
            ...
            <div className="qw-stat-item d-flex align-items-center gap-3 mb-4">
              <div className="qw-stat-icon blue"><RiBriefcaseLine /></div>
              <div>
            ...
            <div className="qw-stat-item d-flex align-items-center gap-3">
              <div className="qw-stat-icon green"><RiVerifiedBadgeFill /></div>
              <div>
          ...
          <div className="qw-card p-4">
            ...
            <div className="d-flex flex-wrap gap-2">
              {profile.skills.map((skill: any) => (
                <span key={skill.id} className="badge bg-light text-primary border px-3 py-2 rounded-pill font-md">
                  {skill.name}
                </span>
              ))}
