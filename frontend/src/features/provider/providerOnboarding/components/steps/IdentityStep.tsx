        ...
        <div className="row g-4">
          ...
          <div className="col-12">
            ...
            <div className="form-text text-muted small">
              A short summary of what you do best.
            </div>
          </div>
          ...
          <div className="col-12">
            ...
            <div className="d-flex justify-content-between mt-1">
              <span
                className={`small ${formData.about.length < 80 ? "text-danger" : "text-success"}`}
              >
                {formData.about.length < 80
                  ? `Minimum 80 characters (${80 - formData.about.length} more needed)`
                  : "Perfect length!"}
              </span>
