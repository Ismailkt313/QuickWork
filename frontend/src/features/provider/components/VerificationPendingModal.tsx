...
const VerificationPendingModal: React.FC<VerificationPendingModalProps> = ({ 
  ...
  return (
    <div className="qw-modal-backdrop animate__animated animate__fadeIn">
      <div className="qw-modal-content edit-profile p-4 animate__animated animate__zoomIn text-center" style={{ maxWidth: '450px' }}>
        ...
        <div className="mb-4">
          <div className="mx-auto mb-3 d-flex align-items-center justify-content-center bg-primary-subtle text-primary rounded-circle" style={{ width: '64px', height: '64px' }}>
            <RiTimeLine size={32} />
          </div>
        ...
        <div className="p-3 rounded-4 bg-light border mb-4 text-start">
          <div className="d-flex gap-3 align-items-start">
            ...
            <div>
              <h4 className="small fw-bold mb-1 text-dark">Why is this required?</h4>
              <p className="mb-0 text-secondary" style={{ fontSize: '13px', lineHeight: '1.5' }}>
                To maintain the highest quality of service on QuickWork, we manually verify all professional certificates and identities before allowing job interactions.
              </p>
            </div>
          </div>
        </div>
