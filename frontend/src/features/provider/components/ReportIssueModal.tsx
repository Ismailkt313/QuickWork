        ...
        <div className="qw-modal-header d-flex justify-content-between align-items-center mb-4">
          <div className="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted small mb-0">Reporting: {clientName}</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit}>
              ...
              {reasons.map((r) => (
                <button
                  ...
                  className={`btn btn-sm rounded-pill px-3 py-2 border transition-all ${
                    reason === r
                       ? "btn-danger border-danger fw-bold shadow-sm"
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              rows={4}
              placeholder="Please provide more details about the issue with this client..."
              value={description}
          ...
          <div className="alert alert-warning border-0 rounded-4 d-flex gap-3 mb-4" style={{ backgroundColor: "#fffbeb" }}>
             ...
             <p className="small text-warning-emphasis mb-0">
               Our support team will investigate this report and evidence.
             </p>
          </div>
