        ...
        <div className="d-flex justify-content-between align-items-start mb-3">
          <div>
            <div className="d-flex align-items-center gap-2 mb-1">
              <span
                className="badge bg-primary-subtle text-primary border border-primary-subtle rounded-pill px-3 py-1"
                style={{
                  fontSize: "10px",
                  fontWeight: 700,
                  letterSpacing: "0.5px",
              ...
              {isRejected && (
                <span
                  className="badge bg-secondary-subtle text-secondary border border-secondary-subtle rounded-pill px-3 py-1"
                  style={{
                    fontSize: "10px",
                    fontWeight: 700,
                    letterSpacing: "0.5px",
            ...
            >
              ...
              <span>
                From <strong>{request.clientName}</strong>
              </span>
            </div>
          </div>
          ...
          <div className="col-md-4">
            <div className="d-flex align-items-center gap-2">
              ...
              <div>
                ...
                >
                  {request.location?.address || "Remote"}
                </div>
              </div>
            </div>
          </div>
        ...
        {isPending ? (
          <div className="d-flex gap-3 mt-2">
            <button
              ...
              className="btn btn-outline-primary rounded-3 fw-bold d-flex align-items-center justify-content-center gap-2 px-4"
              style={{ flex: "0 0 auto", border: "1.5px solid #dbeafe" }}
            >
