    ...
    >
      ...
      <div className="d-flex justify-content-between align-items-start mb-3">
        <div>
          ...
          <div
            className="d-flex align-items-center text-muted gap-3 mt-2"
            style={{ fontSize: "13px" }}
          >
      ...
      <div
        className="row g-3 mt-2 mb-4 p-3 rounded-3"
      ...
      <div className="d-flex justify-content-between align-items-center mt-3">
        <div className="d-flex gap-2 w-100">
          <button
            className="btn btn-outline-primary rounded-pill px-4 py-2 shadow-sm fw-bold d-flex align-items-center justify-content-center gap-2 transition-all hover-translate-x"
            onClick={() => onMessage?.(job.clientId, job.clientName)}
            style={{ fontSize: "14px", flex: "0 0 auto" }}
          >
            <RiMessage2Line /> Text
          </button>
          <button
