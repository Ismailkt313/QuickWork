  ...
  <div className="card border-0 shadow-sm h-100">
    <div className="card-body p-4">
      <div className="d-flex align-items-center mb-3">
        <div className={`p-3 rounded-3 bg-opacity-10 bg-${color} text-${color} me-3`}>
          {icon}
        </div>
        <div>
          <h6 className="card-subtitle text-secondary fw-medium mb-1">{title}</h6>
...
const ProviderDashboardCards: React.FC = () => {
  const stats = [
    ...
    { title: 'Completed Jobs', value: 8, icon: <FaCheckCircle />, color: 'success' },
    { title: 'Total Earnings', value: '₹12,500', icon: <FaRupeeSign />, color: 'warning' },
  ];
