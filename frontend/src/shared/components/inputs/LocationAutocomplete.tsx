...
interface LocationAutocompleteProps {
    ...
    onSelect: (location: { address: string; lat: number; lng: number; district: string }) => void;
    error?: string;
    helperText?: string;
    required?: boolean;
    disabled?: boolean;
        ...
        <div className="mb-4" style={{ position: 'relative' }} ref={dropdownRef}>
            ...
            <div className="input-group">
                ...
                <input
                    ...
                    placeholder={disabled ? `Select a district first` : `Search location in ${districtName}...`}
                    value={query}
                    onChange={(e) => {
                ...
                >
                    {suggestions.map((s) => (
                        ...
                        >
                            ...
                            <span style={{ fontSize: 14, color: '#1e293b' }}>{s.formatted}</span>
                        </div>
                    ))}
                </div>
            )}
