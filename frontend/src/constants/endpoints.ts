export const ENDPOINTS = {
  ...
  ADMIN: {
    ...
    DASHBOARD_FINANCE: "/admin/dashboard/finance-summary",
    SKILLS_LIST: "/skills/admin/list",
    SKILL_CREATE: "/skills/admin/create",
    SKILL_UPDATE: (id: string) => `/skills/admin/update/${id}`,
    SKILL_DELETE: (id: string) => `/skills/admin/delete/${id}`,
    SKILL_TOGGLE: (id: string) => `/skills/admin/toggle-status/${id}`,
  },
  LANDING: "/landing",
};
