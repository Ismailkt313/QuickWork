...
const FOOTER_LINKS = {
  Services: ['Home Cleaning', 'Plumbing', 'Electrical', 'Painting', 'Carpentry'],
...
const Footer: React.FC = () => {
  return (
    <footer style={{ background: '#0f172a', color: '#94a3b8', paddingTop: 56, paddingBottom: 32 }}>
      <div className="container">
        <div className="row g-5 pb-5" style={{ borderBottom: '1px solid #1e293b' }}>
          {/* Brand col */}
          <div className="col-12 col-md-4">
            ...
            <p style={{ fontSize: 14, lineHeight: 1.7, maxWidth: 280, color: '#64748b' }}>
              Connecting people with trusted, local service professionals for every home and business need.
            </p>
          ...
          {Object.entries(FOOTER_LINKS).map(([heading, links]) => (
            <div className="col-6 col-md-auto ms-md-auto" key={heading}>
              <h6 style={{ fontSize: 12, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#e2e8f0', marginBottom: 16 }}>
                {heading}
              </h6>
